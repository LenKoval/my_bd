...
COPY "TESTING".answer (answer_id, name_answer, question_id, is_correct, number_answer) FROM stdin;
1	любой	1	f	1
2	метод main	1	t	2
...
COPY "TESTING".attempt (attempt_id, student_id, subject_id, result, "time") FROM stdin;
1	1	2	2	20
2	4	1	3	20
3	2	1	3	30
\.
